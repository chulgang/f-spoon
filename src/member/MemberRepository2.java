...
public class MemberRepository2 {
	...
	public boolean join(String email, String pwd, String fullName, String phoneNumber, String birthDate, String role,
						int gender) {
		...
		do {
			...
			if (oldMemberEmail.equals(email)) {
				if (decryptedPwd2.equals(pwd)) {
					...
					String insertTokenSql = "insert into token(token_key, token) values (?,?)";
					pstmt11 = con.prepareStatement(insertTokenSql);
					pstmt11.setString(1, tokenArr[0]);
					pstmt11.setString(2, tokenArr[1]);
