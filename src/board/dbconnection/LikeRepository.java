...
public class LikeRepository {
    ...
    public int findCountByMemberNo(Long memberNo) {
        ...
        String sql = "select count(LIKE_NO) from LIKES where MEMBER_NO = " + memberNo;
        ResultSet rs = null;
    ...
    public int findCountByMemberNoAndBoardNo(Long memberNo, Long boardNo) {
        con = DbConnectionThreadLocal.getConnection();
        String sql = "select count(LIKE_NO) from LIKES where MEMBER_NO = ? and BOARD_NO = ? ";
        ResultSet rs = null;
    ...
    public void create(Long boardNo, Long memberNo) {
        con = DbConnectionThreadLocal.getConnection();
        String sql = "insert into LIKES(BOARD_NO, MEMBER_NO) " + "values(?, ?)";
